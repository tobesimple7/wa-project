...
const mainTree = ref([
  {
    ...
    key: 'Lecture100',
    children: [
      { key: 'lecture101', label: '1강. vue.js 안내' },
      { key: 'lecture102', label: '2강. node.js 다운로드' },
      { key: 'lecture103', label: '3강. vscode 편집기' },
      { key: 'lecture104', label: '4강. nvm' },
      { key: 'lecture105', label: '5강. npm' },
      { key: 'lecture106', label: '6강. pnpm' },
      { key: 'lecture107', label: '7강. 강의소스 다운로드' },
    ]
  },  
  {
    ...
    key: 'Lecture200',
    children: [
      { key: 'lecture201', label: '1강. Vue 만들기' },
      { key: 'lecture202', label: '2강. {{ }} Mustache(머스타치)' },
      { key: 'lecture203', label: '3강. v-model (바인딩)' },
      { key: 'lecture204', label: '4강. v-bind (바인딩)' },
      { key: 'lecture205', label: '5강. v-on (이벤트)' },
      { key: 'lecture206', label: '6강. v-model, v-bind 예제' },
      { key: 'lecture207', label: '7강. v-if, v-show' },
      { key: 'lecture208', label: '8강. v-for (반복문)' },
      { key: 'lecture209', label: '9강. v-html, v-text' },
    ]
  },
])
</script>
