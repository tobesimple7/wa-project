...
export class WaPanel99 extends WaPanelBase {
    ...
    createHtml(parentElement: any) {
        ...
        const isShowToolbar: string =
            grid.grid_mode == GridMode.page || grid.grid_mode == GridMode.pagination ? 'wa-grid-show' : 'wa-grid-hide';

        let s = '';
        s += `<div class="wa-grid-panel99 ${isShowToolbar}">`;
            s += '<div class="wa-grid-panel99-wrap">';
                s += '<div class="wa-grid-panel99-page">';
                    s += '<span class="wa-grid-panel99-page-first">◁◁</span>';
                    s += '<span class="wa-grid-panel99-page-prev">◀</span>';
                    s += '<span class="wa-grid-panel99-page-select">1</span>';
                    s += '<span class="wa-grid-panel99-page-next">▶</span>';
                    s += '<span class="wa-grid-panel99-page-last">▷▷</span>';
                    s += '<select class="wa-grid-panel99-page-combo"></select>';
                s += '</div>';
            s += '</div>';
        s += '</div>';
    ...
    createTable() {
        const panel = document.querySelector(`${this.selector} .wa-grid-panel99`);
    ...
    panel99_select(){
        ...
        if (document.querySelector(`${selector} .wa-grid-panel99-page-first`))
            document.querySelector(`${selector} .wa-grid-panel99-page-first`).addEventListener('mousedown', firstEvent);
        ...
        if (document.querySelector(`${selector} .wa-grid-panel99-page-prev`))
            document.querySelector(`${selector} .wa-grid-panel99-page-prev`).addEventListener('mousedown', prevEvent);
        ...
        //     document.querySelector(`${selector} .wa-grid-panel99-page-select`).addEventListener('mousedown', curEvent);
        ...
        if (document.querySelector(`${selector} .wa-grid-panel99-page-next`))
            document.querySelector(`${selector} .wa-grid-panel99-page-next`).addEventListener('mousedown', nextEvent);
        ...
        if (document.querySelector(`${selector} .wa-grid-panel99-page-last`))
            document.querySelector(`${selector} .wa-grid-panel99-page-last`).addEventListener('mousedown', lastEvent);
        ...
        if (document.querySelector(`${selector} .wa-grid-panel99-page-combo`))
            document.querySelector(`${selector} .wa-grid-panel99-page-combo`).addEventListener('change', changeEvent);
    }
    ...
    setPageRowCountList(data?: any[]) {
        ...
        const combo = document.querySelector(`${selector} .wa-grid-panel99-page-combo`);
    ...
    showPagePanel() {
        ...
        const panel = document.querySelector(`${selector} .wa-grid-panel99`);
