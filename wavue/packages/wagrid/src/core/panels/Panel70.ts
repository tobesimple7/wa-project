...
export class WaPanel70 extends WaPanelBase {
    ...
    createHtml(parentElement) {
        ...
        let s = '';
        s += '<div class="wa-grid-group71">';
            s += '<div class="wa-grid-panel">';
            s += '<div class="wa-grid-panel71"><table class="wa-grid-table"></table></div>';
            s += '<div class="wa-grid-panel72"><table class="wa-grid-table"></table></div>';
            s += '</div>';
        s += '</div>';
        s += '<div class="wa-grid-group70">';
            s += '<div class="wa-grid-panel">';
            s += '<div class="wa-grid-panel70"><table class="wa-grid-table"></table></div>';
            s += '</div>';
        s += '</div>';
    ...
    setDataPanel2(param) {
        ...
        for (let x = 0; x <= grid.fixedColumnIndex; x++) {
            ...
            combo.classList.add('wa-grid-cell-filter-combo');
        ...
        for (let x = 0; x <= grid.fixedColumnIndex; x++) {
            ...
            input.classList.add('wa-grid-cell-filter-input');
    ...
    panel70_select(panelName) {
        ...
        const changeEvent = function(e) {
            ...
            let inputs = document.querySelectorAll(selector + ' .wa-grid-' + panelName + ' .wa-grid-cell-filter-input');
        ...
        // let panel70 = document.querySelectorAll(selector + ' .wa-grid-panel70');
        //
