import {BeforeAfter, CellType} from "@/core/WaGrid.types"
import {WaColumnProperty} from "@/core/columns/WaColumnEnum"
import {WaGridCore} from "@/core/WaGridCore";

export class WaGridColumnCore {
    grid: WaGridCore;
    selector: string;
    ...
    getSelectedTableCell(rowIndex?: any, cellIndex?: any) {
        ...
        let trList = document.querySelectorAll(selector + ' .wa-grid-panel31 table tbody tr');
        let trContentList = document.querySelectorAll(selector + ' .wa-grid-panel30 table tbody tr');
    ...
    getRowIndexInTable(tableRowIndex: any, panelName: any = 'panel31') {
        ...
        let tableRows = document.querySelectorAll(selector + ' .wa-grid-' + leftPanelName + ' .wa-grid-table tr');
    ...
    getLeftTableCell(rowIndex: any, panel: any = 'panel31') {1
        ...
        let result = null;
        let tableRows = document.querySelectorAll(selector + ' .wa-grid-' + panel + ' .wa-grid-table tbody tr:not([style*="display:"])');
