...
export class WaDom extends WaBase {
    ...
    static createElement(type){
        ...
        return WaDom.createHtml(tag, tagType, className);
    }
    ...
    static setStyle(tableCell, param)  {
        ...
        WaDom.addUserClass(tableCell, className); // user event
        WaDom.setCellStyle(tableCell, 'display', display);
        WaDom.setCellStyle(tableCell, 'textAlign', textAlign); // user event
        WaDom.setCellStyle(tableCell, 'width', width);
    }
    ...
    static addUserClass(tableCell, className) {
        WaDom.removeUserClass(tableCell);
