...
export class WaScrollBase {
    ...
    setPanelSize() {
        ...
        const main: any    = document.querySelector(selector + ' .wa-grid-main');

        const panel20: any = document.querySelector(selector + ' .wa-grid-panel20');
        const panel22: any = document.querySelector(selector + ' .wa-grid-panel22');

        const panel40: any = document.querySelector(selector + ' .wa-grid-panel40');
        const panel42: any = document.querySelector(selector + ' .wa-grid-panel42');

        const panel72: any = document.querySelector(selector + ' .wa-grid-panel72');

        const group20: any = document.querySelector(selector + ' .wa-grid-group20');
        const group21: any = document.querySelector(selector + ' .wa-grid-group21');

        const group30: any = document.querySelector(selector + ' .wa-grid-group30');
        const group31: any = document.querySelector(selector + ' .wa-grid-group31');

        const group40: any = document.querySelector(selector + ' .wa-grid-group40');
        const group41: any = document.querySelector(selector + ' .wa-grid-group41');

        const group50: any = document.querySelector(selector + ' .wa-grid-group50');
        const group51: any = document.querySelector(selector + ' .wa-grid-group51');

        const group70: any = document.querySelector(selector + ' .wa-grid-group70');
        const group71: any = document.querySelector(selector + ' .wa-grid-group71');
        ...
        const rectTable21: any= document.querySelector(selector + ' .wa-grid-panel21 .wa-grid-table').getBoundingClientRect();

        // Consider hidden columns
        const rectTable20: any= document.querySelector(selector + ' .wa-grid-panel20 .wa-grid-table').getBoundingClientRect();
        ...
        if (grid.options.showFilterPanel) {
            const rectTable70 = document.querySelector(selector + ' .wa-grid-panel70 .wa-grid-table').getBoundingClientRect();
            if (grid.fixedColumnIndex != -1) {
        ...
        if (grid.top_column_table.count() > 0){
            const rectTable40 = document.querySelector(selector + ' .wa-grid-panel40 .wa-grid-table').getBoundingClientRect();
            if (grid.fixedColumnIndex != -1) {
        ...
        const panel30: any = document.querySelector(selector + ' .wa-grid-panel30');
        const panel32: any = document.querySelector(selector + ' .wa-grid-panel32');
        if (grid.fixedColumnIndex != -1) {
        ...
        if (grid.footer_column_table.count() > 0) {
            const panel50: any = document.querySelector(selector + ' .wa-grid-panel50');
            const panel52: any = document.querySelector(selector + ' .wa-grid-panel52');

            if (grid.fixedColumnIndex != -1) {
                const rectTable50  = document.querySelector(selector + ' .wa-grid-panel50 .wa-grid-table').getBoundingClientRect();
    ...
    setBarPosition(type: string, topRowIndex?: number) {
        ...
        if (type == grid.code_horizontal) {
            const table20: any = document.querySelector(selector + ' .wa-grid-panel20 .wa-grid-table');
            const xBar: any = document.querySelector(selector + ' .wa-grid-horizontal-scroll-bar');
            ...
            if (topRowIndex == 0) {
                (document.querySelector(selector + ' .wa-grid-vertical-scroll-bar') as any).style.top = '0px';
            }
                ...
                (document.querySelector(selector + ' .wa-grid-vertical-scroll-bar') as any).style.top = styleTop + 'px';
    ...
    setBarPositionByDirection(type: string, rowIndex?: number): number {
        ...
        if (type == 'right') {
            let hiddenSize = grid.horizontalScroll.hiddenSize;
            let moveWidth = 15;
            const divContent: any = document.querySelector(`${selector} .wa-grid-panel30`);
            const divHeaderMove: any = document.querySelector(`${selector} .wa-grid-panel20 .wa-grid-table`);
            const divContentMove: any = document.querySelector(`${selector} .wa-grid-panel30 .wa-grid-table`);
    ...
    setContentPanelLeft(value) {
        ...
        const panel40: any= document.querySelector(selector + ' .wa-grid-panel40');
        const panel50: any= document.querySelector(selector + ' .wa-grid-panel50');
        const panel70: any= document.querySelector(selector + ' .wa-grid-panel70');
    ...
    setColumnWidth20(panelName, colIndex, value) {
        ...
        const colList : any = document.querySelectorAll(selector + ' .wa-grid-panel20 .wa-grid-table thead th');
        const colList2: any = document.querySelectorAll(selector + ' .wa-grid-panel30 .wa-grid-table thead th');
        const colList3: any = document.querySelectorAll(selector + ' .wa-grid-panel40 .wa-grid-table thead th');
        const colList4: any = document.querySelectorAll(selector + ' .wa-grid-panel50 .wa-grid-table thead th');
    ...
    setColumnWidth22(panelName, colIndex, value) {
        ...
        const colList : any = document.querySelectorAll(selector + ' .wa-grid-panel22 .wa-grid-table thead th');
        const colList2: any = document.querySelectorAll(selector + ' .wa-grid-panel32 .wa-grid-table thead th');
        const colList3: any = document.querySelectorAll(selector + ' .wa-grid-panel42 .wa-grid-table thead th');
        const colList4: any = document.querySelectorAll(selector + ' .wa-grid-panel52 .wa-grid-table thead th');
    ...
    setAllColumnWidth(arr) {
        ...
        const thList20: any = document.querySelectorAll(selector + ' .wa-grid-panel20 .wa-grid-table thead th');
        const thList30: any = document.querySelectorAll(selector + ' .wa-grid-panel30 .wa-grid-table thead th');
        const thList40: any = document.querySelectorAll(selector + ' .wa-grid-panel40 .wa-grid-table thead th');
        const thList50: any = document.querySelectorAll(selector + ' .wa-grid-panel50 .wa-grid-table thead th');
        const thList70: any = document.querySelectorAll(selector + ' .wa-grid-panel70 .wa-grid-table thead th');
    ...
    setPageRowCount(panelName = '') {
        ...
        let contentHeight = parseInt(String(document.querySelector(selector + ' .wa-grid-group30').getBoundingClientRect().height));
