...
export class WaScroll {
    ...
    setHorizontalScroll() {
        ...
        let scrollBox: any = document.querySelector(selector + ' .wa-grid-scroll-box');

        let panel20: any = document.querySelector(selector + ' .wa-grid-panel20');
        ...
        xScroll = document.querySelector(selector + ' .wa-grid-horizontal-scroll'); // non-live
    ...
    setVerticalScroll() {
        ...
        let yScroll: any = document.querySelector(selector + ' .wa-grid-vertical-scroll');
        let scrollBox: any = document.querySelector(selector + ' .wa-grid-scroll-box');
        let wrap: any = document.querySelector(selector + ' .wa-grid-wrap');
        ...
        yScroll = document.querySelector(selector + ' .wa-grid-vertical-scroll'); // non-live
        if (xScroll.style.display == 'none' && yScroll.style.display == 'none') scrollBox.style.display = 'none';
    }
    ...
    hideScroll(type) {
        ...
        if (type == grid.code_horizontal) {
            ...
            const xScroll: any = document.querySelector(selector + ' .wa-grid-horizontal-scroll');
            const yScroll: any = document.querySelector(selector + ' .wa-grid-vertical-scroll');
            const scrollBox: any = document.querySelector(selector + ' .wa-grid-scroll-box');
            ...
            (document.querySelector(selector + ' .wa-grid-horizontal-scroll-bar'  ) as any).style.left = '0px';
            (document.querySelector(selector + ' .wa-grid-panel20 .wa-grid-table') as any).style.left = '0px';
            (document.querySelector(selector + ' .wa-grid-panel30 .wa-grid-table') as any).style.left = '0px';
            (document.querySelector(selector + ' .wa-grid-panel40 .wa-grid-table') as any).style.left = '0px';
            (document.querySelector(selector + ' .wa-grid-panel50 .wa-grid-table') as any).style.left = '0px';
            (document.querySelector(selector + ' .wa-grid-panel70 .wa-grid-table') as any).style.left = '0px';
        }
        else if (type == grid.code_vertical) {
            let xScroll: any = document.querySelector(selector + ' .wa-grid-horizontal-scroll');
            let yScroll: any = document.querySelector(selector + ' .wa-grid-vertical-scroll');
    ...
    getVerticalBarSize() {
        ...
        let yWrap = document.querySelector(selector + ' .wa-grid-vertical-scroll-wrap');
    ...
    getHorizontalRailSize(barSize) {
        ...
        let xWrap = document.querySelector(selector + ' .wa-grid-horizontal-scroll-wrap');
    ...
    getBarWidth(type, barSize) {
        ...
        const grid = this.grid;
        let scroll = this;
        let wrapRect = document.querySelector(selector + ' .wa-grid-horizontal-scroll-wrap').getBoundingClientRect();
        let xBarRect  = document.querySelector(selector + ' .wa-grid-horizontal-scroll-bar').getBoundingClientRect();
