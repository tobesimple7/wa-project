import {AddRowDirection, CellType, GridMode, OptionAlias} from "@/core/WaGrid.types"
...
import {WaGridExcel} from "@/core/export/wa.grid.excel";

export class WaGridBaseMain {
    ...
    addUserClass(this: WaGridCore, element: any, className: string): void { WaGridDom.addUserClass(element, className); }

    removeUserClass(this: WaGridCore, element: any): void { WaGridDom.removeUserClass(element); }
