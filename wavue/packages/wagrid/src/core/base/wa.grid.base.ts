...
import {WaDatabase, DataTableType} from '@/core/database/wa.database';
import {WaDataTable} from '@/core/database/wa.data.table';
import {waGridConfigs} from "../wa.grid.configs";
import {WaDataArrayTable} from "@/core/database/wa.data.array.table";
